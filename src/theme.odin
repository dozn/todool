...
theme_preset_add :: proc(name: string, theme: Theme) {
	...
	append(&theme_presets, Theme_Preset{theme, strings.clone(name), index})
}
...
theme_presets_init :: proc() {
	...
	theme_preset_add(
		"light",
		Theme {
			background = {{200, 200, 200, 255}, {220, 220, 220, 255}, {240, 240, 240, 255}},
			panel = {{240, 240, 240, 255}, {255, 255, 255, 255}, {223, 255, 251, 255}},
	...
	theme_preset_add(
		"black",
		Theme {
			background = {{0, 0, 0, 255}, {20, 20, 20, 255}, {40, 40, 40, 255}},
			panel = {{50, 10, 10, 255}, {40, 40, 40, 255}, {96, 77, 77, 255}},
	...
	theme_preset_add(
		"dark purple",
		Theme {
			background = {{32, 30, 48, 255}, {19, 13, 36, 255}, {0, 0, 0, 255}},
			panel = {{0, 0, 0, 255}, {42, 9, 45, 255}, {97, 63, 100, 255}},
			text_default = {255, 255, 255, 255},
			text_blank = {216, 215, 243, 255},
			text_good = {107, 103, 117, 255},
			text_bad = {189, 149, 174, 255},
			text_link = {181, 205, 137, 255},
			text_date = {54, 104, 249, 255},
			shadow = {49, 49, 49, 255},
			caret = {220, 168, 110, 255},
			caret_selection = {221, 133, 85, 255},
			tags = {
				{207, 56, 139, 255},
				{170, 86, 133, 255},
				{111, 114, 126, 255},
	...
	theme_preset_add(
		"dark green",
		Theme {
			background = {{0, 52, 2, 255}, {9, 28, 10, 255}, {0, 0, 0, 255}},
			panel = {{49, 139, 101, 255}, {32, 122, 84, 255}, {132, 194, 168, 255}},
			text_default = {255, 255, 255, 255},
			text_blank = {202, 202, 202, 255},
			text_good = {77, 255, 130, 255},
			text_bad = {241, 162, 59, 255},
			text_link = {255, 255, 255, 255},
			text_date = {255, 255, 255, 255},
			shadow = {0, 0, 0, 255},
			caret = {255, 22, 22, 255},
			caret_selection = {213, 89, 89, 255},
			tags = {
				{220, 50, 47, 255},
				{159, 34, 94, 255},
				{204, 120, 39, 255},
	...
	theme_preset_add(
		"white green",
		Theme {
			background = {{232, 238, 229, 255}, {240, 233, 232, 255}, {255, 255, 255, 255}},
			panel = {{255, 255, 255, 255}, {247, 250, 234, 255}, {253, 251, 216, 255}},
			text_default = {100, 100, 100, 255},
			text_blank = {98, 122, 100, 255},
			text_good = {18, 190, 21, 255},
			text_bad = {187, 29, 116, 255},
			text_link = {125, 196, 98, 255},
			text_date = {190, 170, 155, 255},
			shadow = {0, 0, 0, 255},
			caret = {177, 137, 52, 255},
			caret_selection = {191, 141, 76, 255},
			tags = {
				{143, 51, 96, 255},
				{157, 25, 137, 255},
				{189, 33, 122, 255},
	...
	theme_preset_add(
		"white orange",
		Theme {
			background = {{222, 222, 227, 255}, {224, 233, 238, 255}, {240, 240, 240, 255}},
			panel = {{240, 240, 240, 255}, {238, 233, 225, 255}, {220, 213, 187, 255}},
			text_default = {0, 0, 0, 255},
			text_blank = {1, 49, 11, 255},
			text_good = {192, 148, 34, 255},
			text_bad = {23, 29, 249, 255},
			text_link = {158, 69, 188, 255},
			text_date = {171, 11, 87, 255},
			shadow = {0, 0, 0, 255},
			caret = {229, 79, 62, 255},
			caret_selection = {221, 75, 59, 255},
			tags = {
				{156, 146, 234, 255},
				{80, 164, 142, 255},
				{160, 138, 236, 255},
	...
	theme_preset_add(
		"beach",
		Theme {
			background = {{131, 229, 236, 255}, {202, 255, 198, 255}, {173, 221, 138, 255}},
			panel = {{255, 224, 82, 255}, {239, 255, 200, 255}, {239, 255, 200, 255}},
			text_default = {68, 68, 68, 255},
			text_blank = {106, 82, 122, 255},
			text_good = {241, 51, 165, 255},
			text_bad = {54, 84, 255, 255},
			text_link = {144, 76, 76, 255},
			text_date = {111, 99, 99, 255},
			shadow = {0, 0, 0, 255},
			caret = {255, 0, 0, 255},
			caret_selection = {255, 202, 202, 255},
			tags = {
				{173, 221, 138, 255},
				{198, 132, 118, 255},
				{202, 133, 169, 255},
	...
	theme_preset_add(
		"nord",
		Theme {
			background = {{46, 52, 64, 255}, {59, 66, 82, 255}, {67, 76, 94, 255}},
			panel = {{62, 71, 89, 255}, {76, 86, 106, 255}, {135, 152, 187, 255}},
			text_default = {216, 222, 233, 255},
			text_blank = {202, 208, 220, 255},
			text_good = {80, 224, 80, 255},
			text_bad = {208, 65, 65, 255},
			text_link = {110, 172, 248, 255},
			text_date = {110, 172, 248, 255},
			shadow = {39, 46, 61, 255},
			caret = {136, 192, 208, 255},
			caret_selection = {210, 245, 255, 255},
			tags = {
				{255, 255, 255, 255},
				{209, 209, 209, 255},
				{193, 193, 193, 255},
	...
	theme_preset_add(
		"witness",
		Theme {
			background = {{7, 38, 38, 255}, {7, 33, 40, 255}, {15, 53, 51, 255}},
			panel = {{30, 56, 51, 255}, {24, 50, 47, 255}, {60, 49, 58, 255}},
			text_default = {179, 147, 105, 255},
			text_blank = {183, 155, 113, 255},
			text_good = {73, 130, 25, 255},
			text_bad = {137, 34, 34, 255},
			text_link = {175, 168, 108, 255},
			text_date = {197, 177, 114, 255},
			shadow = {0, 0, 0, 255},
			caret = {145, 211, 147, 255},
			caret_selection = {185, 131, 165, 255},
			tags = {
				{73, 130, 25, 255},
				{44, 139, 83, 255},
				{99, 153, 29, 255},
	...
	theme_preset_add(
		"monokai",
		Theme {
			background = {{46, 46, 46, 255}, {77, 77, 77, 255}, {121, 121, 121, 255}},
			panel = {{126, 126, 126, 255}, {88, 88, 88, 255}, {144, 117, 117, 255}},
			text_default = {246, 246, 246, 255},
			text_blank = {178, 178, 178, 255},
			text_good = {167, 226, 46, 255},
			text_bad = {102, 217, 238, 255},
			text_link = {174, 129, 255, 255},
			text_date = {174, 129, 255, 255},
			shadow = {0, 0, 0, 255},
			caret = {249, 39, 114, 255},
			caret_selection = {255, 140, 181, 255},
			tags = {
				{70, 175, 202, 255},
				{46, 105, 200, 255},
				{68, 117, 176, 255},
	...
	theme_preset_add(
		"dracula",
		Theme {
			background = {{40, 42, 54, 255}, {45, 48, 64, 255}, {68, 71, 90, 255}},
			panel = {{32, 34, 49, 255}, {68, 71, 90, 255}, {114, 119, 154, 255}},
			text_default = {248, 248, 242, 255},
			text_blank = {160, 167, 189, 255},
			text_good = {80, 250, 123, 255},
			text_bad = {255, 85, 85, 255},
			text_link = {139, 233, 253, 255},
			text_date = {255, 121, 198, 255},
			shadow = {0, 0, 0, 255},
			caret = {241, 250, 140, 255},
			caret_selection = {254, 255, 243, 255},
			tags = {
				{255, 184, 108, 255},
				{221, 153, 165, 255},
				{216, 167, 162, 255},
	...
	theme_preset_add(
		"candy",
		Theme {
			background = {{255, 199, 213, 255}, {255, 168, 189, 255}, {255, 126, 157, 255}},
			panel = {{255, 76, 120, 255}, {255, 126, 157, 255}, {197, 36, 97, 255}},
			text_default = {255, 255, 255, 255},
			text_blank = {41, 41, 41, 255},
			text_good = {230, 255, 107, 255},
			text_bad = {153, 58, 243, 255},
			text_link = {204, 115, 138, 255},
			text_date = {217, 255, 188, 255},
			shadow = {76, 35, 49, 255},
			caret = {85, 214, 219, 255},
			caret_selection = {192, 235, 237, 255},
			tags = {
				{83, 230, 236, 255},
				{57, 181, 226, 255},
				{112, 225, 187, 255},
	...
	theme_preset_add(
		"solarized dark",
		Theme {
			background = {{0, 43, 54, 255}, {7, 54, 66, 255}, {7, 54, 66, 255}},
			panel = {{22, 61, 71, 255}, {26, 69, 80, 255}, {34, 97, 114, 255}},
			text_default = {147, 161, 161, 255},
			text_blank = {106, 118, 122, 255},
			text_good = {133, 153, 0, 255},
			text_bad = {203, 75, 22, 255},
			text_link = {108, 113, 196, 255},
			text_date = {42, 161, 152, 255},
			shadow = {0, 0, 0, 255},
			caret = {253, 246, 227, 255},
			caret_selection = {179, 179, 179, 255},
			tags = {
				{220, 50, 47, 255},
				{159, 34, 94, 255},
				{204, 120, 39, 255},
	...
	theme_preset_add(
		"solarized light",
		Theme {
			background = {{238, 232, 213, 255}, {253, 246, 227, 255}, {255, 240, 201, 255}},
			panel = {{255, 240, 196, 255}, {255, 246, 218, 255}, {192, 222, 208, 255}},
			text_default = {88, 110, 117, 255},
			text_blank = {74, 88, 91, 255},
			text_good = {38, 139, 210, 255},
			text_bad = {220, 50, 47, 255},
			text_link = {108, 113, 196, 255},
			text_date = {42, 161, 152, 255},
			shadow = {189, 181, 156, 255},
			caret = {0, 43, 54, 255},
			caret_selection = {119, 119, 119, 255},
			tags = {
				{133, 153, 0, 255},
				{123, 178, 26, 255},
				{131, 120, 69, 255},
...
theme_task_text :: #force_inline proc(state: Task_State) -> Color {
	...
	case .Done:
		return theme.text_good
	case .Canceled:
		return theme.text_bad
	}
...
theme_editor_skip_from_to :: proc(line_index: int) -> (from, to: int) {
	for skip in theme_editor.skips {
		if skip == -1 {
			continue
		}
...
theme_editor_spawn :: proc(du: u32 = COMBO_EMPTY) {
...

	{
		...
		sg := static_grid_init(p, {}, {200, 100, 75, 75, 100}, 40)
